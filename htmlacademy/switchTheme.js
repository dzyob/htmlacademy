...
buttonTheme.onclick = function () {
    if (!buttonTheme.classList.contains('nextTheme')) {
        ...
        document.getElementById("buttonTheme1").style = "background-color: #ceeaff; color: #260c26; height: 20px; width: 20px; margin-left: 10px;";
    } else {
        document.getElementById("styleLink").href = "basic-light-theme/style.css";
        document.getElementById("buttonTheme1").style = "background-color: #260c26; color: #ceeaff; height: 20px; width: 20px; margin-left: 10px;";
    }
